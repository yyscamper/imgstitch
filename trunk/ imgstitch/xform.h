...
*/
typedef CvMat* (*ransac_xform_fn)( CvPoint2D32f* pts, CvPoint2D32f* mpts,
								  int n );
...
*/
typedef double (*ransac_err_fn)( CvPoint2D32f pt, CvPoint2D32f mpt, CvMat* M );
...
*/
extern CvMat* lsq_homog( CvPoint2D32f* pts, CvPoint2D32f* mpts, int n );
...
*/
extern double homog_xfer_err( CvPoint2D32f pt, CvPoint2D32f mpt, CvMat* H );
...
*/
extern CvPoint2D32f persp_xform_pt( CvPoint2D32f pt, CvMat* T );
